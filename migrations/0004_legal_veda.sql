...
--> statement-breakpoint
DROP TABLE "schema"."account";--> statement-breakpoint
DROP TABLE "schema"."authenticator";--> statement-breakpoint
DROP TABLE "schema"."comment";--> statement-breakpoint
DROP TABLE "schema"."post";--> statement-breakpoint
DROP TABLE "schema"."session";--> statement-breakpoint
DROP TABLE "schema"."user";--> statement-breakpoint
DROP TABLE "schema"."verificationToken";--> statement-breakpoint
DO $$ BEGIN
